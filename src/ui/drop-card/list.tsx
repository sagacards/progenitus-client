...
export default function DropCardList (props : Props) {
    ...
    const e = React.useMemo(() => Object.values(events).reduce((agg, e) => ([...Object.values(agg), ...Object.values(e).filter(e => e.endDate.toMillis() > DateTime.now().toMillis())]), [] as MintingEvent[]), [events]);
