...
import { principalToAddress, principalToAddressBytes, toHexString, fromHexString } from 'ictool';
...
export const createAccountSlice : StoreSlice<AccountStore, CompleteStore> = (set, get) => ({
    ...
    async withdraw (amount : number) {
        ...
        const { actors : { bazaar }, principal, fetchBalance } = get();
        ...
        return bazaar.transfer({ e8s: BigInt(amount.toFixed()) }, address)
        .catch(e => {
            console.error(e);
