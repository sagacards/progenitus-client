...
export const idlFactory : IDL.InterfaceFactory = ({ IDL }) => {
  ...
  const LegendsNFT = IDL.Service({
    ...
    'assetsDelete' : IDL.Func([IDL.Text], [Result], []),
    ...
    'configureStockColors' : IDL.Func([IDL.Vec(CardStock)], [], []),
    ...
    'launchpadBalanceOf' : IDL.Func([IDL.Principal], [IDL.Nat], ['query']),
    'launchpadEventCreate' : IDL.Func([Data], [IDL.Nat], []),
    'launchpadEventUpdate' : IDL.Func([IDL.Nat, Data], [Result__1], []),
    'launchpadMint' : IDL.Func([IDL.Principal], [Result_6], []),
    ...
    'nnsTransfer' : IDL.Func([ICP, IDL.Text, Memo__1], [TransferResult__1], []),
    ...
    'renderManifest' : IDL.Func([IDL.Nat], [Result_4], ['query']),
    ...
    'withdrawAll' : IDL.Func([IDL.Vec(IDL.Nat8)], [TransferResult], []),
  });
  return LegendsNFT;
};
