...
export type Access = { Private: StableAllowlist } | { Public: null };
...
export type MintError = { NoneAvailable: null } | { TryCatchTrap: null };
...
export type Result = { ok: bigint } | { err: MintError };
